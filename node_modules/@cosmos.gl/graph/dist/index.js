...
function mm(t) {
  return function() {
    ...
    return n === Ps && e.documentElement.namespaceURI === Ps ? e.createElement(t) : e.createElementNS(n, t);
  };
}
function pm(t) {
  return function() {
...
function gm(t) {
  ...
  for (var e = this._groups, n = e.length, i = new Array(n), r = 0; r < n; ++r)
    for (var o = e[r], s = o.length, f = i[r] = new Array(s), l, u, m = 0; m < s; ++m)
      (l = o[m]) && (u = t.call(l, l.__data__, m, o)) && ("__data__" in l && (u.__data__ = l.__data__), f[m] = u);
...
function bm(t) {
  return function() {
    return ym(t.apply(this, arguments));
  };
}
function _m(t) {
  typeof t == "function" ? t = bm(t) : t = qu(t);
  for (var e = this._groups, n = e.length, i = [], r = [], o = 0; o < n; ++o)
    for (var s = e[o], f = s.length, l, u = 0; u < f; ++u)
      (l = s[u]) && (i.push(t.call(l, l.__data__, u, s)), r.push(l));
  return new nn(i, r);
}
function Yu(t) {
  return function() {
...
function Am(t) {
  return this.select(t == null ? wm : Tm(typeof t == "function" ? t : Zu(t)));
}
...
function km(t) {
  return this.selectAll(t == null ? Cm : Pm(typeof t == "function" ? t : Zu(t)));
}
function Im(t) {
  typeof t != "function" && (t = Yu(t));
  for (var e = this._groups, n = e.length, i = new Array(n), r = 0; r < n; ++r)
    for (var o = e[r], s = o.length, f = i[r] = [], l, u = 0; u < s; ++u)
      (l = o[u]) && t.call(l, l.__data__, u, o) && f.push(l);
  return new nn(i, this._parents);
}
function Qu(t) {
...
function zm(t, e, n, i, r, o, s) {
  ...
  for (f = 0; f < y; ++f)
    D = s.call(t, o[f], f, o) + "", (l = u.get(D)) ? (i[f] = l, l.__data__ = o[f], u.delete(D)) : n[f] = new na(t, o[f]);
  for (f = 0; f < m; ++f)
...
function Mm(t, e) {
  ...
  for (var o = r.length, s = new Array(o), f = new Array(o), l = new Array(o), u = 0; u < o; ++u) {
    var m = i[u], y = r[u], S = y.length, D = Om(t.call(m, m && m.__data__, u, i)), q = D.length, Te = f[u] = new Array(q), we = s[u] = new Array(q), fe = l[u] = new Array(S);
    n(m, y, Te, we, fe, D, e);
...
function Bm(t) {
  for (var e = t.selection ? t.selection() : t, n = this._groups, i = e._groups, r = n.length, o = i.length, s = Math.min(r, o), f = new Array(r), l = 0; l < s; ++l)
...
function Qi(t, e) {
  return t.style.getPropertyValue(e) || Ku(t).getComputedStyle(t, null).getPropertyValue(e);
}
function sp(t) {
  return function() {
    delete this[t];
...
function up(t, e) {
  return arguments.length > 1 ? this.each((e == null ? sp : typeof e == "function" ? lp : fp)(t, e)) : this.node()[t];
}
function Ju(t) {
...
function tc(t, e) {
  for (var n = Ys(t), i = -1, r = e.length; ++i < r; ) n.add(e[i]);
}
function nc(t, e) {
  for (var n = Ys(t), i = -1, r = e.length; ++i < r; ) n.remove(e[i]);
}
function cp(t) {
  return function() {
    tc(this, t);
...
function dp(t, e) {
  return function() {
    (e.apply(this, arguments) ? tc : nc)(this, t);
  };
}
function mp(t, e) {
  var n = Ju(t + "");
...
function yp(t) {
  return arguments.length ? this.each(t == null ? pp : (typeof t == "function" ? gp : vp)(t)) : this.node().textContent;
}
function xp() {
  this.innerHTML = "";
}
...
function Sp(t) {
  return arguments.length ? this.each(t == null ? xp : (typeof t == "function" ? _p : bp)(t)) : this.node().innerHTML;
}
function Tp() {
...
function Cp(t) {
  var e = typeof t == "function" ? t : ju(t);
...
function kp(t, e) {
  var n = typeof t == "function" ? t : ju(t), i = e == null ? Pp : typeof e == "function" ? e : qs(e);
  return this.select(function() {
...
function Vp(t, e) {
  return function() {
    return ic(this, t, e.apply(this, arguments));
  };
}
function $p(t, e) {
  return this.each((typeof e == "function" ? Vp : Up)(t, e));
}
function* Hp() {
  for (var t = this._groups, e = 0, n = t.length; e < n; ++e)
...
function zt(t) {
  return typeof t == "string" ? new nn([[document.querySelector(t)]], [document.documentElement]) : new nn([[t]], rc);
}
function Xp(t) {
  let e;
...
function Mn(t, e) {
  if (t = Xp(t), e === void 0 && (e = t.currentTarget), e) {
...
Uo.prototype = ha.prototype = {
  constructor: Uo,
  on: function(t, e) {
    var n = this._, i = qp(t + "", n), r, o = -1, s = i.length;
    if (arguments.length < 2) {
      for (; ++o < s; ) if ((r = (t = i[o]).type) && (r = Yp(n[r], t.name))) return r;
      return;
    }
    if (e != null && typeof e != "function") throw new Error("invalid callback: " + e);
    for (; ++o < s; )
      if (r = (t = i[o]).type) n[r] = Ql(n[r], t.name, e);
      else if (e == null) for (r in n) n[r] = Ql(n[r], t.name, null);
    return this;
  },
  copy: function() {
    var t = {}, e = this._;
...
var Ki = 0, kr = 0, Sr = 0, oc = 1e3, ia, Ir, ra = 0, wi = 0, da = 0, Dr = typeof performance == "object" && performance.now ? performance : Date, ac = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function Zs() {
...
oa.prototype = sc.prototype = {
  ...
  restart: function(t, e, n) {
    ...
    n = (n == null ? Zs() : +n) + (e == null ? 0 : +e), !this._next && Ir !== this && (Ir ? Ir._next = this : ia = this, Ir = this), this._call = t, this._time = n, ks();
  },
  stop: function() {
...
function Jp() {
  for (var t, e = ia, n, i = 1 / 0; e; )
    e._call ? (i > e._time && (i = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : ia = n);
  Ir = t, ks(i);
}
function ks(t) {
  if (!Ki) {
    ...
    var e = t - wi;
    e > 24 ? (t < 1 / 0 && (kr = setTimeout(Kl, t - Dr.now() - da)), Sr && (Sr = clearInterval(Sr))) : (Sr || (ra = Dr.now(), Sr = setInterval(Kp, oc)), Ki = 1, ac(Kl));
  }
}
function Jl(t, e, n) {
  var i = new oa();
...
var e0 = ha("start", "end", "cancel", "interrupt"), t0 = [], fc = 0, eu = 1, Is = 2, Vo = 3, tu = 4, Ls = 5, $o = 6;
  ...
  function s(u) {
    ...
    for (m in i)
      if (D = i[m], D.name === n.name) {
        ...
        D.state === tu ? (D.state = $o, D.timer.stop(), D.on.call("interrupt", t, t.__data__, D.index, D.group), delete i[m]) : +m < e && (D.state = $o, D.timer.stop(), D.on.call("cancel", t, t.__data__, D.index, D.group), delete i[m]);
      }
    if (Jl(function() {
      ...
      for (n.state = Vo, r = new Array(S = n.tween.length), m = 0, y = -1; m < S; ++m)
        (D = n.tween[m].value.call(t, t.__data__, n.index, n.group)) && (r[++y] = D);
      r.length = y + 1;
    }
  }
  function f(u) {
    for (var m = u < n.duration ? n.ease.call(null, u / n.duration) : (n.timer.restart(l), n.state = Ls, 1), y = -1, S = r.length; ++y < S; )
      r[y].call(t, m);
    n.state === Ls && (n.on.call("end", t, t.__data__, n.index, n.group), l());
  }
  function l() {
...
function Ho(t, e) {
  ...
  if (n) {
    ...
    for (s in n) {
      ...
      r = i.state > Is && i.state < Ls, i.state = $o, i.timer.stop(), i.on.call(r ? "interrupt" : "cancel", t, t.__data__, i.index, i.group), delete n[s];
    }
...
var Fr = 0.7, aa = 1 / Fr, Yi = "\\s*([+-]?\\d+)\\s*", zr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", En = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", r0 = /^#([0-9a-f]{3,8})$/, o0 = new RegExp(`^rgb\\(${Yi},${Yi},${Yi}\\)$`), a0 = new RegExp(`^rgb\\(${En},${En},${En}\\)$`), s0 = new RegExp(`^rgba\\(${Yi},${Yi},${Yi},${zr}\\)$`), f0 = new RegExp(`^rgba\\(${En},${En},${En},${zr}\\)$`), l0 = new RegExp(`^hsl\\(${zr},${En},${En}\\)$`), u0 = new RegExp(`^hsla\\(${zr},${En},${En},${zr}\\)$`), nu = {
  aliceblue: 15792383,
...
function Jn(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = r0.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? ou(e) : n === 3 ? new Kt(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? Fo(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? Fo(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = o0.exec(t)) ? new Kt(e[1], e[2], e[3], 1) : (e = a0.exec(t)) ? new Kt(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = s0.exec(t)) ? Fo(e[1], e[2], e[3], e[4]) : (e = f0.exec(t)) ? Fo(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = l0.exec(t)) ? fu(e[1], e[2] / 100, e[3] / 100, 1) : (e = u0.exec(t)) ? fu(e[1], e[2] / 100, e[3] / 100, e[4]) : nu.hasOwnProperty(t) ? ou(nu[t]) : t === "transparent" ? new Kt(NaN, NaN, NaN, 0) : null;
}
function ou(t) {
  return new Kt(t >> 16 & 255, t >> 8 & 255, t & 255, 1);
}
function Fo(t, e, n, i) {
  return i <= 0 && (t = e = n = NaN), new Kt(t, e, n, i);
}
function d0(t) {
  return t instanceof Or || (t = Jn(t)), t ? (t = t.rgb(), new Kt(t.r, t.g, t.b, t.opacity)) : new Kt();
}
function Ds(t, e, n, i) {
  return arguments.length === 1 ? d0(t) : new Kt(t, e, n, i ?? 1);
}
function Kt(t, e, n, i) {
...
function uc(t) {
  ...
  t = t.rgb();
  var e = t.r / 255, n = t.g / 255, i = t.b / 255, r = Math.min(e, n, i), o = Math.max(e, n, i), s = NaN, f = o - r, l = (o + r) / 2;
  return f ? (e === o ? s = (n - i) / f + (n < i) * 6 : n === o ? s = (i - e) / f + 2 : s = (e - n) / f + 4, f /= l < 0.5 ? o + r : 2 - o - r, s *= 60) : f = l > 0 && l < 1 ? 0 : s, new vn(s, f, l, t.opacity);
}
function p0(t, e, n, i) {
  return arguments.length === 1 ? uc(t) : new vn(t, e, n, i ?? 1);
}
function vn(t, e, n, i) {
...
Ks(vn, p0, lc(Or, {
  ...
  darker(t) {
    return t = t == null ? Fr : Math.pow(Fr, t), new vn(this.h, this.s, this.l * t, this.opacity);
  },
  rgb() {
  ...
  formatHsl() {
    const t = sa(this.opacity);
    return `${t === 1 ? "hsl(" : "hsla("}${lu(this.h)}, ${zo(this.s) * 100}%, ${zo(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
  }
}));
function lu(t) {
...
function y0(t) {
  return (t = +t) == 1 ? cc : function(e, n) {
    return n - e ? g0(e, n, t) : Js(isNaN(e) ? n : e);
  };
}
function cc(t, e) {
  var n = e - t;
  return n ? v0(t, n) : Js(isNaN(t) ? e : t);
}
...
function T0(t, e) {
  ...
  for (r in e)
    r in t ? n[r] = ef(t[r], e[r]) : i[r] = e[r];
  return function(o) {
    for (r in n) i[r] = n[r](o);
    return i;
  };
}
var Fs = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, ys = new RegExp(Fs.source, "g");
function w0(t) {
  return function() {
    return t;
  };
...
function ef(t, e) {
  var n = typeof e, i;
  return e == null || n === "boolean" ? Js(e) : (n === "number" ? pn : n === "string" ? (i = Jn(e)) ? (e = i, fa) : hc : e instanceof Jn ? fa : e instanceof Date ? S0 : b0(e) ? x0 : Array.isArray(e) ? _0 : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? T0 : pn)(t, e);
}
function E0(t, e) {
  return t = +t, e = +e, function(n) {
...
function dc(t, e, n, i, r, o) {
  var s, f, l;
  return (s = Math.sqrt(t * t + e * e)) && (t /= s, e /= s), (l = t * n + e * i) && (n -= t * l, i -= e * l), (f = Math.sqrt(n * n + i * i)) && (n /= f, i /= f, l /= f), t * i < e * n && (t = -t, e = -e, l = -l, s = -s), {
    translateX: r,
    translateY: o,
    rotate: Math.atan2(e, t) * uu,
...
function mc(t, e, n, i) {
  ...
  return function(u, m) {
    var y = [], S = [];
    return u = t(u), m = t(m), o(u.translateX, u.translateY, m.translateX, m.translateY, y, S), s(u.rotate, m.rotate, y, S), f(u.skewX, m.skewX, y, S), l(u.scaleX, u.scaleY, m.scaleX, m.scaleY, y, S), u = m = null, function(D) {
...
function O0(t, e) {
  ...
  return this.each((e == null ? R0 : M0)(n, t, e));
}
function tf(t, e, n) {
  var i = t._id;
...
function pc(t, e) {
  var n;
  return (typeof e == "number" ? pn : e instanceof Jn ? fa : (n = Jn(e)) ? (e = n, fa) : hc)(t, e);
}
function N0(t) {
  return function() {
    this.removeAttribute(t);
...
function V0(t, e, n) {
  ...
  return function() {
    var s, f = n(this), l;
    return f == null ? void this.removeAttribute(t) : (s = this.getAttribute(t), l = f + "", s === l ? null : s === i && l === r ? o : (r = l, o = e(i = s, f)));
  };
}
function $0(t, e, n) {
  var i, r, o;
  return function() {
    var s, f = n(this), l;
    return f == null ? void this.removeAttributeNS(t.space, t.local) : (s = this.getAttributeNS(t.space, t.local), l = f + "", s === l ? null : s === i && l === r ? o : (r = l, o = e(i = s, f)));
  };
}
function H0(t, e) {
  var n = ca(t), i = n === "transform" ? I0 : pc;
  return this.attrTween(t, typeof e == "function" ? (n.local ? $0 : V0)(n, i, tf(this, "attr." + t, e)) : e == null ? (n.local ? G0 : N0)(n) : (n.local ? U0 : B0)(n, i, e));
}
function W0(t, e) {
  return function(n) {
...
function K0(t) {
  var e = this._id;
  return arguments.length ? this.each((typeof t == "function" ? Z0 : Q0)(e, t)) : yn(this.node(), e).delay;
}
function J0(t, e) {
  return function() {
    Cn(this, t).duration = +e.apply(this, arguments);
  };
}
function ev(t, e) {
  return e = +e, function() {
    Cn(this, t).duration = e;
  };
}
function tv(t) {
  var e = this._id;
  return arguments.length ? this.each((typeof t == "function" ? J0 : ev)(e, t)) : yn(this.node(), e).duration;
}
function nv(t, e) {
  if (typeof e != "function") throw new Error();
  return function() {
...
function iv(t) {
  var e = this._id;
  return arguments.length ? this.each(nv(e, t)) : yn(this.node(), e).ease;
}
function rv(t, e) {
  return function() {
    var n = e.apply(this, arguments);
...
function uv(t, e) {
  var n = this._id;
  return arguments.length < 2 ? yn(this.node(), n).on.on(t) : this.each(lv(n, t, e));
}
function cv(t) {
  return function() {
...
function dv(t) {
  ...
  for (var i = this._groups, r = i.length, o = new Array(r), s = 0; s < r; ++s)
    for (var f = i[s], l = f.length, u = o[s] = new Array(l), m, y, S = 0; S < l; ++S)
      (m = f[S]) && (y = t.call(m, m.__data__, S, f)) && ("__data__" in m && (y.__data__ = m.__data__), u[S] = y, ma(u[S], e, n, S, u, yn(m, n)));
...
function mv(t) {
  ...
  for (var i = this._groups, r = i.length, o = [], s = [], f = 0; f < r; ++f)
    for (var l = i[f], u = l.length, m, y = 0; y < u; ++y)
      if (m = l[y]) {
        for (var S = t.call(m, m.__data__, y, l), D, q = yn(m, n), Te = 0, we = S.length; Te < we; ++Te)
...
function gv(t, e) {
  var n, i, r;
  return function() {
    var o = Qi(this, t), s = (this.style.removeProperty(t), Qi(this, t));
...
function xv(t, e, n) {
  var i, r, o;
  return function() {
    var s = Qi(this, t), f = n(this), l = f + "";
    return f == null && (l = f = (this.style.removeProperty(t), Qi(this, t))), s === l ? null : s === i && l === r ? o : (r = l, o = e(i = s, f));
  };
}
function bv(t, e) {
  var n, i, r, o = "style." + e, s = "end." + o, f;
  return function() {
    var l = Cn(this, t), u = l.on, m = l.value[o] == null ? f || (f = vc(e)) : void 0;
    (u !== n || r !== m) && (i = (n = u).copy()).on(s, r = m), l.on = i;
  };
}
function _v(t, e, n) {
  var i = (t += "") == "transform" ? k0 : pc;
  return e == null ? this.styleTween(t, gv(t, i)).on("end.style." + t, vc(t)) : typeof e == "function" ? this.styleTween(t, xv(t, i, tf(this, "style." + t, e))).each(bv(this._id, t)) : this.styleTween(t, yv(t, i, e), n).on("end.style." + t, null);
}
function Sv(t, e, n) {
  return function(i) {
...
function Cv(t) {
  return this.tween("text", typeof t == "function" ? Ev(tf(this, "text", t)) : Av(t == null ? "" : t + ""));
}
function Pv(t) {
  return function(e) {
...
function Dv() {
  ...
  return new Promise(function(o, s) {
    ...
    n.each(function() {
      ...
      m !== t && (e = (t = m).copy(), e._.cancel.push(f), e._.interrupt.push(f), e._.end.push(l)), u.on = e;
    }), r === 0 && o();
  });
}
var Fv = 0;
...
var Wo = { exports: {} }, Vv = Wo.exports, hu;
function $v() {
...
`, "color:red;text-decoration:underline;font-weight:bold"), ae.lines.forEach(function(ne) {
      ...
      function Li(a, h, _) {
        ...
        a !== document.body && typeof ResizeObserver == "function" ? (R = new ResizeObserver(function() {
          setTimeout(W);
        }), R.observe(a)) : window.addEventListener("resize", W, !1);
        function B() {
      ...
      function It(a) {
        var h = a || {}, _, M, W, R, B = {}, K = [], Q = [], re = typeof window > "u" ? 1 : window.devicePixelRatio, ae = !1, oe = function(ne) {
          ne && d.raise(ne);
        }, ue = function() {
        };
      ...
      var un = 3408, qr = 3410, Yr = 3411, Zr = 3412, Qr = 3413, ba = 3414, $e = 3415, P = 33901, ve = 33902, ze = 3379, mt = 3386, Mt = 34921, wt = 36347, Ht = 36348, cn = 35661, ai = 35660, rr = 34930, Ot = 36349, Kr = 34076, Jr = 34024, Uc = 7936, Vc = 7937, $c = 7938, Hc = 35724, Wc = 34047, Xc = 36063, jc = 34852, eo = 3553, af = 34067, qc = 34069, Yc = 33984, or = 6408, _a = 5126, sf = 5121, Sa = 36160, Zc = 36053, Qc = 36064, Kc = 16384, Jc = function(a, h) {
        ...
        if (R) {
          ...
          if (a.bindFramebuffer(Sa, K), a.framebufferTexture2D(Sa, Qc, eo, B, 0), a.bindTexture(eo, null), a.checkFramebufferStatus(Sa) !== Zc) R = !1;
          else {
            a.viewport(0, 0, 1, 1), a.clearColor(1, 0, 0, 1), a.clear(Kc);
            var Q = gt.allocType(_a, 4);
            a.readPixels(0, 0, 1, 1, or, _a, Q), a.getError() ? R = !1 : (a.deleteFramebuffer(K), a.deleteTexture(B), R = Q[0] === 1), gt.freeType(Q);
          }
        }
        var re = typeof navigator < "u" && (/MSIE/.test(navigator.userAgent) || /Trident\//.test(navigator.appVersion) || /Edge/.test(navigator.userAgent)), ae = !0;
        if (!re) {
      ...
      function ph(a, h, _, M) {
        ...
        function Q(k, G) {
          var te = K.pop();
          return te || (te = new B(k)), te.bind(), oe(te, G, mh, 0, 1, !1), te;
        }
        function re(k) {
          K.push(k);
        }
      ...
      function Ch(a, h, _, M) {
        ...
        function J(ne, k) {
          var G = _.create(null, Ca, !0), te = new K(G._buffer);
          M.elementsCount++;
          function xe(Z) {
            if (!Z)
      ...
      function rd(a, h, _, M, W, R, B) {
        ...
        function X() {
          this.internalformat = li, this.format = li, this.type = Oi, this.compressed = !1, this.premultiplyAlpha = !1, this.flipY = !1, this.unpackAlignment = 1, this.colorSpace = Lf, this.width = 0, this.height = 0, this.channels = 0;
        }
        function H(x, O) {
        ...
        function Se(x, O) {
          if (!(typeof O != "object" || !O)) {
            ...
            ), _e = O.shape[0], Ke = O.shape[1], O.shape.length === 3 && (p = O.shape[2], d(p > 0 && p <= 4, "invalid number of channels"), c = !0), d(_e >= 0 && _e <= _.maxTextureSize, "invalid width"), d(Ke >= 0 && Ke <= _.maxTextureSize, "invalid height")) : ("radius" in O && (_e = Ke = O.radius, d(_e >= 0 && _e <= _.maxTextureSize, "invalid radius")), "width" in O && (_e = O.width, d(_e >= 0 && _e <= _.maxTextureSize, "invalid width")), "height" in O && (Ke = O.height, d(Ke >= 0 && Ke <= _.maxTextureSize, "invalid height")), "channels" in O && (p = O.channels, d(p > 0 && p <= 4, "invalid number of channels"), c = !0)), x.width = _e | 0, x.height = Ke | 0, x.channels = p | 0;
            var T = !1;
            if ("format" in O) {
              var C = O.format;
              d(
              ...
              x.format = De[I], C in ue && ("type" in O || (x.type = ue[C])), C in ne && (x.compressed = !0), T = !0;
            }
        ...
        function he(x, O) {
          ...
          if (Ha(O) ? z = O : O && (d.type(O, "object", "invalid pixel data type"), Se(x, O), "x" in O && (x.xOffset = O.x | 0), "y" in O && (x.yOffset = O.y | 0), Ha(O.data) && (z = O.data)), d(
            ...
            x.width = x.width || _e - x.xOffset, x.height = x.height || Ke - x.yOffset, x.needsCopy = !0, d(
            ...
            x.channels = x.channels || 4, nd(x, z), x.alignment = 1, x.needsFree = !0;
          else if (hn(z)) {
            var p = z.data;
            !Array.isArray(p) && x.type === Oi && (x.type = Vf(p));
            var c = z.shape, T = z.stride, C, I, A, w, E, v;
            c.length === 3 ? (A = c[2], v = T[2]) : (d(c.length === 2, "invalid ndarray pixel data, must be 2 or 3D"), A = 1, v = 1), C = c[0], I = c[1], w = T[0], E = T[1], x.alignment = 1, x.width = C, x.height = I, x.channels = A, x.format = x.internalformat = lo[A], x.needsFree = !0, id(x, p, w, E, v, z.offset);
            ...
            for (var L = to.shape(z), $ = 1, j = 0; j < L.length; ++j)
              $ *= L[j];
            var le = $f(x, $);
            to.flatten(z, L, "", le), Hf(x, le), x.alignment = 1, x.width = b, x.height = g, x.channels = F, x.format = x.internalformat = lo[F], x.needsFree = !0;
          }
          x.type === fr ? d(
        ...
        function Re() {
          X.call(this), this.genMipmaps = !1, this.mipmapHint = fo, this.mipmask = 0, this.images = Array(16);
        }
        function We(x, O, z) {
        ...
        function ht() {
          this.minFilter = Ua, this.magFilter = Ua, this.wrapS = Ba, this.wrapT = Ba, this.anisotropic = 1, this.genMipmaps = !1, this.mipmapHint = fo;
        }
        function Tt(x, O) {
          if ("min" in O) {
            var z = O.min;
            d.parameter(z, ae), x.minFilter = ae[z], Zh.indexOf(x.minFilter) >= 0 && !("faces" in O) && (x.genMipmaps = !0);
          }
          if ("mag" in O) {
            var _e = O.mag;
            ...
            switch (typeof O.mipmap) {
              case "string":
                d.parameter(
                  ...
                  K,
                  "invalid mipmap hint"
                ), x.mipmapHint = K[O.mipmap], x.genMipmaps = !0, A = !0;
                break;
              case "boolean":
                A = x.genMipmaps = O.mipmap;
                break;
              case "object":
                d(Array.isArray(O.mipmap), "invalid mipmap type"), x.genMipmaps = !1, A = !0;
                break;
              default:
      ...
      function Ad(a, h, _, M, W, R) {
        ...
        function H(ee, he) {
          ...
          function He(pe, ye) {
            ...
            var We = 0, Je = 0, vt = !0, yt = !0, tt = null, At = !0, ht = "rgba", Tt = "uint8", Et = 1, Ct = null, Ft = null, Gt = null, xt = !1;
            if (typeof pe == "number")
              We = pe | 0, Je = ye | 0 || We;
            else if (!pe)
              We = Je = 1;
              ...
              ), ht = "rgba32f"), d.oneOf(Tt, re, "invalid color type")), "colorFormat" in Ye && (ht = Ye.colorFormat, K.indexOf(ht) >= 0 ? At = !0 : Q.indexOf(ht) >= 0 ? At = !1 : d.optional(function() {
                At ? d.oneOf(
                  Ye.colorFormat,
                  K,
              ...
              )), "depth" in Ye && (typeof Ye.depth == "boolean" ? vt = Ye.depth : (Ct = Ye.depth, yt = !1)), "stencil" in Ye && (typeof Ye.stencil == "boolean" ? yt = Ye.stencil : (Ft = Ye.stencil, vt = !1)), "depthStencil" in Ye && (typeof Ye.depthStencil == "boolean" ? vt = yt = Ye.depthStencil : (Gt = Ye.depthStencil, vt = !1, yt = !1));
            }
        ...
        function ce() {
          B.cur = null, B.next = null, B.dirty = !0, Jt(Z).forEach(function(ee) {
      ...
      function ja() {
        this.state = 0, this.x = 0, this.y = 0, this.z = 0, this.w = 0, this.buffer = null, this.size = 0, this.normalized = !1, this.type = Ed, this.offset = 0, this.stride = 0, this.divisor = 0;
      }
      function Cd(a, h, _, M, W, R, B) {
        ...
        function ge() {
          this.id = ++ae, this.attributes = [], this.elements = null, this.ownsElements = !1, this.count = 0, this.offset = 0, this.instances = -1, this.primitive = 4;
          var X = ne();
        ...
        ge.prototype.bindAttrs = function() {
          ...
          this.ownsElements && (this.elements.destroy(), this.elements = null, this.ownsElements = !1), oe[this.id] && (delete oe[this.id], M.vaoCount -= 1);
        };
        function me() {
          var X = ne();
        ...
        function De(X) {
          ...
          function Se(ce) {
            var ee;
            if (Array.isArray(ce))
              ee = ce, H.elements && H.ownsElements && H.elements.destroy(), H.elements = null, H.ownsElements = !1, H.offset = 0, H.count = 0, H.instances = -1, H.primitive = 4;
            else {
              if (d(typeof ce == "object", "invalid arguments for create vao"), d("attributes" in ce, "must specify attributes for vao"), ce.elements) {
                var he = ce.elements;
                H.ownsElements ? typeof he == "function" && he._reglType === "elements" ? (H.elements.destroy(), H.ownsElements = !1) : (H.elements(he), H.ownsElements = !1) : R.getElements(ce.elements) ? (H.elements = ce.elements, H.ownsElements = !1) : (H.elements = R.create(ce.elements), H.ownsElements = !0);
              } else
...
`), J = Function.apply(null, h.concat(ue));
      ...
      function nm(a, h, _, M, W, R, B, K, Q, re, ae, oe, ue, J, ne) {
        ...
        ce(pl, Hd), ce(vl, $d), ee(gl, "blendColor", [0, 0, 0, 0]), ee(
          ...
          "blendFuncSeparate",
          [Ml, Rl, Ml, Rl]
        ), ce(yl, Xd, !0), ee(xl, "depthFunc", em), ee(bl, "depthRange", [0, 1]), ee(_l, "depthMask", !0), ee(ts, ts, [!0, !0, !0, !0]), ce(Sl, Vd), ee(Tl, "cullFace", vi), ee(ns, ns, ps), ee(is, is, 1), ce(wl, qd), ee(rs, "polygonOffset", [0, 0]), ce(Al, Yd), ce(El, Zd), ee(os, "sampleCoverage", [1, !1]), ce(Cl, Wd), ee(Pl, "stencilMask", -1), ee(as, "stencilFunc", [Jd, 0, -1]), ee(
          ss,
          "stencilOpSeparate",
          [_r, qn, qn, qn]
        ), ee(
        ...
        function Re(p, c, T) {
          ...
          function A(v) {
            if (v in C) {
              ...
              var g = !0, F = b.x | 0, L = b.y | 0, $, j;
              return "width" in b ? ($ = b.width | 0, d.command($ >= 0, "invalid " + v, T.commandStr)) : g = !1, "height" in b ? (j = b.height | 0, d.command(j >= 0, "invalid " + v, T.commandStr)) : g = !1, new Lt(
                !g && c && c.thisDep,
                !g && c && c.contextDep,
                !g && c && c.propDep,
                function(Ie, be) {
        ...
        function vt(p, c) {
          var T = p.static, C = p.dynamic, I = {}, A = !1;
          function w() {
            if (pr in T) {
              var be = T[pr];
              return be !== null && re.getVAO(be) === null && (be = re.createVAO(be)), A = !0, I.vao = be, St(function(U) {
                var Ce = re.getVAO(be);
          ...
          function b() {
            if (di in T) {
              ...
              if (I.elements = be, Io(be)) {
                var Y = I.elements = R.create(be, !0);
                be = R.getElements(Y), v = !0;
              } else be && (be = R.getElements(be), v = !0, d.command(be, "invalid elements", c.commandStr));
        ...
        function Tt(p, c, T, C, I) {
          ...
          if (le.profile = pe(p), le.uniforms = tt(T, I), le.drawVAO = le.scopeVAO = g.vao, !le.drawVAO && L.program && !E && _.angle_instanced_arrays && g.static.elements) {
            var Ne = !0, Ie = L.program.attributes.map(function(Y) {
              var U = c.static[Y];
              return Ne = Ne && !!U, U;
            });
            if (Ne && Ie.length > 0) {
          ...
          return E ? le.useVAO = !0 : le.attributes = At(c, I), le.context = ht(C), le;
        }
        function Et(p, c, T) {
        ...
        function bt(p, c) {
          var T = p.proc("draw", 1);
          xt(p, T), Et(p, T, c.context), Ct(p, T, c.framebuffer), Ft(p, T, c), Gt(p, T, c.state), Ye(p, T, c, !1, !0);
        ...
        function Tn(p, c, T, C) {
          ...
          Bt(p, c, T, C.attributes, I), at(p, c, T, C.uniforms, I, !1), Fe(p, c, c, T);
        }
        function gi(p, c, T, C) {
          xt(p, c);
          ...
          if (T.needsContext && Et(p, g, T.context), T.needsFramebuffer && Ct(p, g, T.framebuffer), Gt(p, g, T.state, F), T.profile && F(T.profile) && Ye(p, g, T, !1, !0), C)
            T.useVAO ? T.drawVAO ? F(T.drawVAO) ? g(p.shared.vao, ".setVAO(", T.drawVAO.append(p, g), ");") : b(p.shared.vao, ".setVAO(", T.drawVAO.append(p, b), ");") : b(p.shared.vao, ".setVAO(", p.shared.vao, ".targetVAO);") : (b(p.shared.vao, ".setVAO(null);"), Bt(p, b, T, C.attributes, L), Bt(p, g, T, C.attributes, F)), at(p, b, T, C.uniforms, L, !1), at(p, g, T, C.uniforms, F, !0), Fe(p, b, g, T);
          else {
        ...
        function x(p, c) {
          ...
          }), C || (Et(p, T, c.context), I = !1);
          var A = c.framebuffer, w = !1;
          A ? (A.propDep ? C = w = !0 : A.contextDep && C && (w = !0), w || Ct(p, T, A)) : Ct(p, T, null), c.state.viewport && c.state.viewport.propDep && (C = !0);
          function E($) {
            return $.contextDep && C || $.propDep;
          }
          Ft(p, T, c), Gt(p, T, c.state, function($) {
            return !E($);
          }), (!c.profile || !E(c.profile)) && Ye(p, T, c, !1, "a1"), c.contextDep = C, c.needsContext = I, c.needsFramebuffer = w;
        ...
        function O(p, c) {
          ...
          }), Ye(p, T, c, !0, !0), [di, xo, pi, bo, mi].forEach(
            function(w) {
              var E = c.draw[w];
        ...
        function _e(p, c, T) {
          ...
          if (!C || !z(C))
            return;
          var I = p.global, A = Object.keys(C), w = !1, E = !1, v = !1, b = p.global.def("{}");
        ...
        return {
          ...
          procs: function() {
            ...
            C(E, ".dirty=false;"), Ct(p, c), Ct(p, T, null, !0);
            var v;
      ...
      function dm(a) {
        ...
        function vt(Fe) {
          Fe.preventDefault(), W = !0, Je(), He.forEach(function(et) {
            et();
          });
        }
        function yt(Fe) {
          _.getError(), W = !1, R.restore(), me.restore(), te.restore(), De.restore(), X.restore(), H.restore(), Z.restore(), re && re.restore(), Se.procs.refresh(), We(), Ue.forEach(function(et) {
            et();
          });
        }
        he && (he.addEventListener(Hl, vt, !1), he.addEventListener(Wl, yt, !1));
        function tt() {
        ...
        function At(Fe) {
          ...
          var bt = it(Fe.context || {}, !0), Tn = it(Fe.uniforms || {}, !0), gi = it(Fe.attributes || {}, !1), x = it(et(Fe), !1), O = {
            gpuTime: 0,
            cpuTime: 0,
            count: 0
...
var Hv = $v();
const Wv = /* @__PURE__ */ nf(Hv), Xv = "#b3b3b3", jv = void 0, Rs = void 0, qv = 1, Yv = 4, Zv = "#666666", Qv = 0.1, Kv = 1, Jv = 1, yc = "#222222", Ge = {
  enableSimulation: !0,
  spaceSize: 8192,
  pointSizeScale: 1,
  linkWidthScale: 1,
...
const Mo = qt(Array.prototype.forEach), ag = qt(Array.prototype.lastIndexOf), mu = qt(Array.prototype.pop), Tr = qt(Array.prototype.push), sg = qt(Array.prototype.splice), Xo = qt(String.prototype.toLowerCase), xs = qt(String.prototype.toString), pu = qt(String.prototype.match), wr = qt(String.prototype.replace), fg = qt(String.prototype.indexOf), lg = qt(String.prototype.trim), mn = qt(Object.prototype.hasOwnProperty), Xt = qt(RegExp.prototype.test), Ar = ug(TypeError);
function qt(t) {
  return function(e) {
...
function Rn(t) {
  const e = bc(null);
  for (const [n, i] of xc(t))
    mn(t, n) && (Array.isArray(i) ? e[n] = cg(i) : i && typeof i == "object" && i.constructor === Object ? e[n] = Rn(i) : e[n] = i);
  return e;
}
function Er(t, e) {
  for (; t !== null; ) {
...
function Tc() {
  ...
  const e = ($e) => Tc($e);
  if (e.version = "3.2.6", e.removed = [], !t || !t.document || t.document.nodeType !== Cr.document || !t.Element)
  ...
  const i = n, r = i.currentScript, {
    ...
    DOMParser: S,
    trustedTypes: D
  } = t, q = l.prototype, Te = Er(q, "cloneNode"), we = Er(q, "remove"), fe = Er(q, "nextSibling"), Oe = Er(q, "childNodes"), Ve = Er(q, "parentNode");
  ...
  })), Vt = null, $t = null, Yt = !0, Pn = !0, Nr = !1, Gr = !0, kn = !1, ei = !0, xn = !1, Ei = !1, Ci = !1, Bn = !1, Rt = !1, ti = !1, ni = !0, Br = !1;
  const va = "user-content-";
  let d = !0, ii = !1, Un = {}, Vn = null;
  ...
  const qr = function(P) {
    ...
    return P instanceof l && !xa(P) || (ze === "noscript" || ze === "noembed" || ze === "noframes") && Xt(/<\/no(script|embed|frames)/i, P.innerHTML) ? (on(P), !0) : (kn && P.nodeType === Cr.text && (ve = P.textContent, Mo([ut, rt, N], (mt) => {
      ve = wr(ve, mt, " ");
    }), P.textContent !== ve && (Tr(e.removed, {
      element: P.cloneNode()
    }), P.textContent = ve)), un(Ee.afterSanitizeElements, P, null), !1);
  }, Yr = function(P, ve, ze) {
    ...
    for (; mt--; ) {
      ...
      if (ze.attrName = ai, ze.attrValue = Ot, ze.keepAttr = !0, ze.forceKeepAttr = void 0, un(Ee.uponSanitizeAttribute, P, ze), Ot = ze.attrValue, Br && (ai === "id" || ai === "name") && (Hn(wt, P), Ot = va + Ot), ei && Xt(/((--!?|])>)|<\/(style|title)/i, Ot)) {
        Hn(wt, P);
        continue;
      }
      if (ze.forceKeepAttr)
  ...
  return e.sanitize = function($e) {
    ...
    if (!e.isSupported)
      return $e;
    if (Ei || nr(P), e.removed = [], typeof $e == "string" && (ii = !1), ii) {
      if ($e.nodeName) {
      ...
      ve = jr("<!---->"), ze = ve.ownerDocument.importNode($e, !0), ze.nodeType === Cr.element && ze.nodeName === "BODY" || ze.nodeName === "HTML" ? ve = ze : ve.appendChild(ze);
    else {
    ...
    if (Bn) {
      if (Rt)
        ...
        Mt = ve;
      return (ct.shadowroot || ct.shadowrootmode) && (Mt = lt.call(i, Mt, !0)), Mt;
    }
...
var wg = Tc();
const Ag = (t) => typeof t == "function", wc = (t) => Array.isArray(t), Eg = (t) => t instanceof Object, Cg = (t) => t instanceof Object ? t.constructor.name !== "Function" && t.constructor.name !== "Object" : !1, Su = (t) => Eg(t) && !wc(t) && !Ag(t) && !Cg(t);
function Kn(t) {
  let e;
  if (wc(t))
    e = t;
  else {
    const n = Jn(t), i = n == null ? void 0 : n.rgb();
...
function Ti(t) {
  const e = new Float32Array(t * t * 2);
  for (let n = 0; n < t; n++)
    for (let i = 0; i < t; i++) {
      const r = n * t * 2 + i * 2;
      e[r + 0] = i, e[r + 1] = n;
...
var jo = { exports: {} }, Zg = jo.exports, wu;
function Qg() {
...
`;
      class r {
         ...
         */
        addUI(s) {
          this.names.indexOf(s) == -1 && (this.names.push(s), this.dom && (this.dom.insertAdjacentHTML("beforeend", this.svg), this.updateUI()), this.cpuAccums.push(0), this.gpuAccums.push(0), this.activeAccums.push(!1));
        }
        /**
         * Increase frameID
...
var ty = /* @__PURE__ */ ((t) => (t[t.Circle = 0] = "Circle", t[t.Square = 1] = "Square", t[t.Triangle = 2] = "Triangle", t[t.Diamond = 3] = "Diamond", t[t.Pentagon = 4] = "Pentagon", t[t.Hexagon = 5] = "Hexagon", t[t.Star = 6] = "Star", t[t.Cross = 7] = "Cross", t[t.None = 8] = "None", t))(ty || {});
class ny {
  constructor(e) {
    this._config = e;
  }
...
function Cc(t) {
  let e, n, i;
  t.length !== 2 ? (e = qo, n = (f, l) => qo(t(f), l), i = (f, l) => t(f) - l) : (e = t === qo || t === sy ? t : fy, n = t, i = t);
...
var Gs = Math.sqrt(50), Bs = Math.sqrt(10), Us = Math.sqrt(2);
function hy(t, e, n) {
  var i, r = -1, o, s, f;
  if (e = +e, t = +t, n = +n, t === e && n > 0) return [t];
  if ((i = e < t) && (o = t, t = e, e = o), (f = Pc(t, e, n)) === 0 || !isFinite(f)) return [];
  if (f > 0) {
    let l = Math.round(t / f), u = Math.round(e / f);
    for (l * f < t && ++l, u * f > e && --u, s = new Array(o = u - l + 1); ++r < o; ) s[r] = (l + r) * f;
  } else {
    f = -f;
    let l = Math.round(t * f), u = Math.round(e * f);
    for (l / f < t && ++l, u / f > e && --u, s = new Array(o = u - l + 1); ++r < o; ) s[r] = (l + r) / f;
...
function dy(t, e, n) {
  ...
  return o >= Gs ? r *= 10 : o >= Bs ? r *= 5 : o >= Us && (r *= 2), e < t ? -r : r;
}
function my(t, e, n) {
...
function Lc() {
  var t = Cu, e = Cu, n = ef, i, r, o, s = An, f, l, u;
  function m() {
    var S = Math.min(t.length, e.length);
    return s !== An && (s = gy(t[0], t[S - 1])), f = S > 2 ? xy : yy, l = u = null, y;
  }
  function y(S) {
    return S == null || isNaN(S = +S) ? o : (l || (l = f(t.map(i), e, n)))(i(s(S)));
  }
  return y.invert = function(S) {
    return s(r((u || (u = f(e, t.map(i), pn)))(S)));
  }, y.domain = function(S) {
    return arguments.length ? (t = Array.from(S, vy), m()) : t.slice();
  }, y.range = function(S) {
    return arguments.length ? (e = Array.from(S), m()) : e.slice();
  }, y.rangeRound = function(S) {
    return e = Array.from(S), n = E0, m();
  }, y.clamp = function(S) {
    return arguments.length ? (s = S ? !0 : An, m()) : s !== An;
...
function Ji(t) {
  return t = la(Math.abs(t)), t ? t[1] : NaN;
}
function Sy(t, e) {
  return function(n, i) {
    for (var r = n.length, o = [], s = 0, f = t[0], l = 0; r > 0 && f > 0 && (l + f + 1 > i && (f = Math.max(1, i - l)), o.push(n.substring(r -= f, r + f)), !((l += f + 1) > i)); )
      f = t[s = (s + 1) % t.length];
...
function Ay(t) {
  e: for (var e = t.length, n = 1, i = -1, r; n < e; ++n)
    switch (t[n]) {
      case ".":
        i = r = n;
        break;
...
function Ey(t, e) {
  ...
  return o === s ? i : o > s ? i + new Array(o - s + 1).join("0") : o > 0 ? i.slice(0, o) + "." + i.slice(o) : "0." + new Array(1 - o).join("0") + la(t, Math.max(0, e + o - 1))[0];
}
function Pu(t, e) {
  var n = la(t, e);
  if (!n) return t + "";
...
var Lu = Array.prototype.map, Du = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function Cy(t) {
  var e = t.grouping === void 0 || t.thousands === void 0 ? Iu : Sy(Lu.call(t.grouping, Number), t.thousands + ""), n = t.currency === void 0 ? "" : t.currency[0] + "", i = t.currency === void 0 ? "" : t.currency[1] + "", r = t.decimal === void 0 ? "." : t.decimal + "", o = t.numerals === void 0 ? Iu : Ty(Lu.call(t.numerals, String)), s = t.percent === void 0 ? "%" : t.percent + "", f = t.minus === void 0 ? "−" : t.minus + "", l = t.nan === void 0 ? "NaN" : t.nan + "";
  function u(y) {
    y = ua(y);
    var S = y.fill, D = y.align, q = y.sign, Te = y.symbol, we = y.zero, fe = y.width, Oe = y.comma, Ve = y.precision, V = y.trim, se = y.type;
    se === "n" ? (Oe = !0, se = "g") : ku[se] || (Ve === void 0 && (Ve = 12), V = !0, se = "g"), (we || S === "0" && D === "=") && (we = !0, S = "0", D = "=");
    ...
    function lt(Ee) {
      ...
      if (se === "c")
        ...
        Ee = +Ee;
        var ke = Ee < 0 || 1 / Ee < 0;
        if (Ee = isNaN(Ee) ? l : Xe(Math.abs(Ee), Ve), V && (Ee = Ay(Ee)), ke && +Ee == 0 && q !== "+" && (ke = !1), ut = (ke ? q === "(" ? q : f : q === "-" || q === "(" ? "" : q) + ut, rt = (se === "s" ? Du[8 + Dc / 3] : "") + rt + (ke && q === "(" ? ")" : ""), nt) {
...
function Py(t) {
  return No = Cy(t), Fc = No.format, zc = No.formatPrefix, No;
}
function ky(t) {
  return Math.max(0, -Ji(Math.abs(t)));
}
function Iy(t, e) {
  return Math.max(0, Math.max(-8, Math.min(8, Math.floor(Ji(e) / 3))) * 3 - Ji(Math.abs(t)));
}
function Ly(t, e) {
  return t = Math.abs(t), e = Math.abs(e) - t, Math.max(0, Ji(e) - Ji(t)) + 1;
}
function Dy(t, e, n, i) {
  var r = dy(t, e, n), o;
  switch (i = ua(i ?? ",f"), i.type) {
    ...
    case "p":
    case "r": {
      i.precision == null && !isNaN(o = Ly(r, Math.max(Math.abs(t), Math.abs(e)))) && (i.precision = o - (i.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function Ry(t) {
  var e = t(An, An), n = 1;
  function i() {
    return n === 1 ? t(An, An) : n === 0.5 ? t(Fy, zy) : t(Fu(n), Fu(1 / n));
  }
...
function Mc() {
  var t = Ry(Lc());
  return t.copy = function() {
    return Ic(t, Mc()).exponent(t.exponent());
  }, kc.apply(t, arguments), t;
}
const My = (t) => {
  const e = Mc().exponent(2).range([0, 1]).domain([-1, 1]), n = my(0, t).map((r) => -0.5 + r / t);
  n.push(0.5);
...
function Qy(t, e = 16384) {
  ...
  const i = n, r = Math.ceil(Math.sqrt(t.length));
  let o = r * n, s = 1;
...
class Ky extends Gn {
  ...
  updatePositions() {
    ...
    let l = r;
    r === void 0 && !o && (l = !0), this.shouldSkipRescale && (l = !1), l ? this.rescaleInitialNodePositions() : this.shouldSkipRescale || (this.scaleX = void 0, this.scaleY = void 0), this.shouldSkipRescale = void 0;
    for (let u = 0; u < i.pointsNumber; ++u)
  ...
  updatePosition() {
    var e;
    (e = this.updatePositionCommand) == null || e.call(this), this.swapFbo(), this.isPositionsUpToDate = !1;
  }
  drag() {
    var e;
    (e = this.dragPointCommand) == null || e.call(this), this.swapFbo(), this.isPositionsUpToDate = !1;
  }
  ...
  trackPointsByIndices(e) {
    ...
    if (this.trackedIndices = e, this.trackedPositions = void 0, this.isPositionsUpToDate = !1, !(e != null && e.length) || !n) return;
...
function Jy() {
  var t = new zu(9);
  return zu != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[5] = 0, t[6] = 0, t[7] = 0), t[0] = 1, t[4] = 1, t[8] = 1, t;
}
function Ru(t, e, n) {
  var i = e[0], r = e[1], o = e[2], s = e[3], f = e[4], l = e[5], u = e[6], m = e[7], y = e[8], S = n[0], D = n[1];
  return t[0] = i, t[1] = r, t[2] = o, t[3] = s, t[4] = f, t[5] = l, t[6] = S * i + D * s + u, t[7] = S * r + D * f + m, t[8] = S * o + D * l + y, t;
}
function ws(t, e, n) {
  var i = n[0], r = n[1];
...
var Yo = { exports: {} }, tx = Yo.exports, Mu;
function nx() {
...
var Zo = { exports: {} }, ix = Zo.exports, Ou;
function rx() {
...
var Qo = { exports: {} }, ox = Qo.exports, Nu;
function ax() {
...
var Ko = { exports: {} }, sx = Ko.exports, Gu;
function fx() {
...
var Jo = { exports: {} }, lx = Jo.exports, Bu;
function ux() {
...
var ea = { exports: {} }, cx = ea.exports, Uu;
function hx() {
...
var ta = { exports: {} };
const dx = {}, mx = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: dx
}, Symbol.toStringTag, { value: "Module" })), px = /* @__PURE__ */ Uv(mx);
var vx = ta.exports, Vu;
function gx() {
...
function yx() {
  if ($u) return As;
  $u = 1;
  var t = nx(), e = rx(), n = ax(), i = fx(), r = ux(), o = hx(), s = gx();
  return s.alea = t, s.xor128 = e, s.xorwow = n, s.xorshift7 = i, s.xor4096 = r, s.tychei = o, As = s, As;
}
var xx = yx();
const bx = /* @__PURE__ */ nf(xx);
function _x(t, e) {
  for (var n = 0; n < e.length; n++) {
    var i = e[n];
    i.enumerable = i.enumerable || !1, i.configurable = !0, "value" in i && (i.writable = !0), Object.defineProperty(t, Tx(i.key), i);
  }
}
function of(t, e, n) {
  return e && _x(t.prototype, e), Object.defineProperty(t, "prototype", {
    writable: !1
  }), t;
}
function Oc(t, e) {
  t.prototype = Object.create(e.prototype), t.prototype.constructor = t, Hs(t, e);
}
function Hs(t, e) {
...
var pa = /* @__PURE__ */ function() {
...
}(), Hu = /* @__PURE__ */ function(t) {
  Oc(e, t);
  function e(i, r) {
    var o;
    return o = t.call(this) || this, o._rng = void 0, o.seed(i, r), o;
  }
  var n = e.prototype;
  ...
  switch (typeof i) {
    ...
    case "string":
    default:
      return new Hu(bx.apply(void 0, t));
  }
...
var Ax = function(e) {
  ...
  return e === void 0 && (e = 0), n === void 0 && (n = 1), function() {
    var i, r, o;
    do
      i = t.next() * 2 - 1, r = t.next() * 2 - 1, o = i * i + r * r;
    while (!o || o > 1);
...
}, Fx = [0, 0, 0.6931471805599453, 1.791759469228055, 3.1780538303479458, 4.787491742782046, 6.579251212010101, 8.525161361065415, 10.60460290274525, 12.801827480081469], zx = function(e) {
  return Fx[e];
}, Rx = 0.9189385332046727, Mx = function(t, e) {
  if (e === void 0 && (e = 1), gn(e).isPositive(), e < 10) {
    var n = Math.exp(-e);
    return function() {
      for (var l = n, u = 0, m = t.next(); m > l; )
        m = m - l, l = e * l / ++u;
      return u;
    };
  } else {
    ...
    return function() {
      for (; ; ) {
        var l = void 0, u = t.next();
        if (u <= 0.86 * f)
          return l = u / f - 0.43, Math.floor((2 * o / (0.5 - Math.abs(l)) + r) * l + e + 0.445);
        u >= f ? l = t.next() - 0.5 : (l = u / f - 0.93, l = (l < 0 ? -0.5 : 0.5) - l, u = t.next() * f);
  ...
  return e.clone = function() {
    ...
    return i.length ? new t(Wu.apply(void 0, i)) : new t(this.rng.clone());
  }, e.use = function() {
...
new Nc();
const Ws = 1e-3, Xs = 64, Vx = 4;
class $x {
  constructor() {
    this.pointsTextureSize = 0, this.linksTextureSize = 0, this.alpha = 1, this.transform = Jy(), this.screenSize = [0, 0], this.mousePosition = [0, 0], this.screenMousePosition = [0, 0], this.selectedArea = [[0, 0], [0, 0]], this.isSimulationRunning = !1, this.simulationProgress = 0, this.selectedIndices = null, this.maxPointSize = Xs, this.hoveredPoint = void 0, this.focusedPoint = void 0, this.draggingPointIndex = void 0, this.hoveredLinkIndex = void 0, this.adjustedSpaceSize = Ge.spaceSize, this.isSpaceKeyPressed = !1, this.webglMaxTextureSize = 16384, this.hoveredPointRingColor = [1, 1, 1, eg], this.focusedPointRingColor = [1, 1, 1, tg], this.hoveredLinkColor = [-1, -1, -1, -1], this.greyoutPointColor = [-1, -1, -1, -1], this.isDarkenGreyout = !1, this.isLinkHoveringEnabled = !1, this.alphaTarget = 0, this.scalePointX = $s(), this.scalePointY = $s(), this.random = new Nc(), this._backgroundColor = [0, 0, 0, 0], this.alphaDecay = (e) => 1 - Math.pow(Ws, 1 / e);
  }
  get backgroundColor() {
...
const Hx = { passive: !1 }, Rr = { capture: !0, passive: !1 };
function Es(t) {
...
function Gc(t) {
  var e = t.document.documentElement, n = zt(t).on("dragstart.drag", Zi, Rr);
  "onselectstart" in e ? n.on("selectstart.drag", Zi, Rr) : (e.__noselect = e.style.MozUserSelect, e.style.MozUserSelect = "none");
}
function Bc(t, e) {
  var n = t.document.documentElement, i = zt(t).on("dragstart.drag", null);
...
function Yx() {
  var t = Wx, e = Xx, n = jx, i = qx, r = {}, o = ha("start", "drag", "end"), s = 0, f, l, u, m, y = 0;
  function S(V) {
  ...
  function D(V, se) {
    if (!(m || !t.call(this, V, se))) {
      var Le = Ve(this, e.call(this, V, se), V, se, "mouse");
      Le && (zt(V.view).on("mousemove.drag", q, Rr).on("mouseup.drag", Te, Rr), Gc(V.view), Es(V), u = !1, f = V.clientX, l = V.clientY, Le("start", V));
    }
  }
  function q(V) {
    if (Zi(V), !u) {
  ...
  return S.filter = function(V) {
    return arguments.length ? (t = typeof V == "function" ? V : Go(!!V), S) : t;
...
function nb() {
  var t = Qx, e = Kx, n = tb, i = Jx, r = eb, o = [0, 1 / 0], s = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], f = 250, l = z0, u = ha("start", "zoom", "end"), m, y, S, D = 500, q = 150, Te = 0, we = 10;
  function fe(N) {
    N.property("__zoom", Xu).on("wheel.zoom", Xe, { passive: !1 }).on("mousedown.zoom", nt).on("dblclick.zoom", lt).filter(r).on("touchstart.zoom", Ee).on("touchmove.zoom", ut).on("touchend.zoom touchcancel.zoom", rt).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  ...
  function nt(N, ...Pe) {
    ...
    var ie = N.currentTarget, ke = Le(this, Pe, !0).event(N), qe = zt(N.view).on("mousemove.zoom", dt, !0).on("mouseup.zoom", ct, !0), je = Mn(N, ie), Qe = N.clientX, Ze = N.clientY;
  ...
  function Ee(N, ...Pe) {
    if (t.apply(this, arguments)) {
      ...
      for (Cs(N), Qe = 0; Qe < ke; ++Qe)
        Ze = ie[Qe], dt = Mn(Ze, this), dt = [dt, this.__zoom.invert(dt), Ze.identifier], qe.touch0 ? !qe.touch1 && qe.touch0[2] !== dt[2] && (qe.touch1 = dt, qe.taps = 0) : (qe.touch0 = dt, je = !0, qe.taps = 1 + !!m);
  ...
  return fe.wheelDelta = function(N) {
    ...
    return arguments.length ? (t = typeof N == "function" ? N : Bo(!!N), fe) : t;
...
class ib {
  constructor(e, n) {
    ...
    }), this.isRunning = !1, this.store = e, this.config = n;
  }
  /**
...
class rb {
  constructor(e, n) {
    this.isActive = !1, this.behavior = Yx().subject((i) => this.store.hoveredPoint && !this.store.isSpaceKeyPressed ? { x: i.x, y: i.y } : void 0).on("start", (i) => {
      var r, o;
      this.store.hoveredPoint && (this.store.draggingPointIndex = this.store.hoveredPoint.index, this.isActive = !0, (o = (r = this.config) == null ? void 0 : r.onDragStart) == null || o.call(r, i));
    }).on("drag", (i) => {
      var r, o;
      (o = (r = this.config) == null ? void 0 : r.onDrag) == null || o.call(r, i);
    }).on("end", (i) => {
      var r, o;
      this.isActive = !1, this.store.draggingPointIndex = void 0, (o = (r = this.config) == null ? void 0 : r.onDragEnd) == null || o.call(r, i);
...
class ab {
  constructor(e, n) {
    ...
    try {
      ...
      ob(this.store.div), this._isDestroyed = !0;
      return;
    }
    this.reglInstance = s, this.store.adjustSpaceSize(this.config.spaceSize, this.reglInstance.limits.maxTextureSize), this.store.setWebGLMaxTextureSize(this.reglInstance.limits.maxTextureSize), this.store.updateScreenSize(r, o), this.canvasD3Selection = zt(this.canvas), this.canvasD3Selection.on("mouseenter.cosmos", () => {
      ...
      this._isMouseOnCanvas = !1, this.currentEvent = f, this.store.hoveredPoint !== void 0 && this.config.onPointMouseOut && this.config.onPointMouseOut(f), this.store.hoveredLinkIndex !== void 0 && this.config.onLinkMouseOut && this.config.onLinkMouseOut(f), this.isRightClickMouse = !1, this.store.hoveredPoint = void 0, this.store.hoveredLinkIndex = void 0, this.updateCanvasCursor();
    }), zt(document).on("keydown.cosmos", (f) => {
      f.code === "Space" && (this.store.isSpaceKeyPressed = !0);
    }).on("keyup.cosmos", (f) => {
      f.code === "Space" && (this.store.isSpaceKeyPressed = !1);
  ...
  */
  setPointColors(e) {
    this._isDestroyed || (this.graph.inputPointColors = e, this.isPointColorUpdateNeeded = !0);
  }
  /**
   ...
   */
  setPointSizes(e) {
    this._isDestroyed || (this.graph.inputPointSizes = e, this.isPointSizeUpdateNeeded = !0);
  }
  /**
   ...
   */
  setPointShapes(e) {
    this._isDestroyed || (this.graph.inputPointShapes = e, this.isPointShapeUpdateNeeded = !0);
  }
  /**
  ...
  setPointImageIndices(e) {
    this._isDestroyed || (this.graph.inputPointImageIndices = e, this.isPointImageIndicesUpdateNeeded = !0);
  }
  /**
  ...
  setPointImageSizes(e) {
    this._isDestroyed || (this.graph.inputPointImageSizes = e, this.isPointImageSizesUpdateNeeded = !0);
  }
  /**
   ...
   */
  setLinks(e) {
    this._isDestroyed || (this.graph.inputLinks = e, this.isLinksUpdateNeeded = !0, this.isLinkColorUpdateNeeded = !0, this.isLinkWidthUpdateNeeded = !0, this.isLinkArrowUpdateNeeded = !0, this.isForceLinkUpdateNeeded = !0);
  }
  /**
   ...
   */
  setLinkColors(e) {
    this._isDestroyed || (this.graph.inputLinkColors = e, this.isLinkColorUpdateNeeded = !0);
  }
  /**
   ...
   */
  setLinkWidths(e) {
    this._isDestroyed || (this.graph.inputLinkWidths = e, this.isLinkWidthUpdateNeeded = !0);
  }
  /**
   ...
   */
  setLinkArrows(e) {
    this._isDestroyed || (this.graph.linkArrowsBoolean = e, this.isLinkArrowUpdateNeeded = !0);
  }
  /**
   ...
   */
  setLinkStrength(e) {
    this._isDestroyed || (this.graph.inputLinkStrength = e, this.isForceLinkUpdateNeeded = !0);
  }
  /**
   ...
   */
  setPointClusters(e) {
    this._isDestroyed || (this.graph.inputPointClusters = e, this.isPointClusterUpdateNeeded = !0);
  }
  /**
  ...
  setClusterPositions(e) {
    this._isDestroyed || (this.graph.inputClusterPositions = e, this.isPointClusterUpdateNeeded = !0);
  }
  /**
  ...
  setPointClusterStrength(e) {
    this._isDestroyed || (this.graph.inputClusterStrength = e, this.isPointClusterUpdateNeeded = !0);
  }
  /**
   * Renders the graph.
   *
  ...
  render(e) {
    ...
    }, i)), this._isFirstRenderAfterInit = !1, this.update(e);
  }
  /**
   ...
   */
  zoomToPointByIndex(e, n = 700, i = ng, r = !0) {
  ...
  start(e = 1) {
    var n, i;
    this._isDestroyed || this.graph.pointsNumber && (e > 0 && (this.store.isSimulationRunning = !0, this.store.simulationProgress = 0, (i = (n = this.config).onSimulationStart) == null || i.call(n)), this.store.alpha = e, this.stopFrames(), this.frame());
  }
  /**
  ...
  pause() {
    var e, n;
    this._isDestroyed || (this.store.isSimulationRunning = !1, (n = (e = this.config).onSimulationPause) == null || n.call(e));
  }
  /**
  ...
  unpause() {
    var e, n;
    this._isDestroyed || (this.store.isSimulationRunning = !0, (n = (e = this.config).onSimulationUnpause) == null || n.call(e));
  }
  /**
  ...
  restart() {
    var e, n;
    this._isDestroyed || (this.store.isSimulationRunning = !0, (n = (e = this.config).onSimulationRestart) == null || n.call(e));
  }
  /**
   * Render only one frame of the simulation (stops the simulation if it was running).
   */
  step() {
    this._isDestroyed || (this.store.isSimulationRunning = !1, this.stopFrames(), this.frame());
  }
  /**
  ...
  destroy() {
    ...
    this._isDestroyed || !this.reglInstance || (window.clearTimeout(this._fitViewOnInitTimeoutID), this.stopFrames(), this.canvasD3Selection && this.canvasD3Selection.on("mouseenter.cosmos", null).on("mousemove.cosmos", null).on("mouseleave.cosmos", null).on("click", null).on("mousemove", null).on("contextmenu", null).on(".drag", null).on(".zoom", null), zt(document).on("keydown.cosmos", null).on("keyup.cosmos", null), (e = this.zoomInstance) != null && e.behavior && this.zoomInstance.behavior.on("start.detect", null).on("zoom.detect", null).on("end.detect", null), (n = this.dragInstance) != null && n.behavior && this.dragInstance.behavior.on("start.detect", null).on("drag.detect", null).on("end.detect", null), (i = this.fpsMonitor) == null || i.destroy(), this.reglInstance.destroy(), this.reglInstance.clear({
      ...
      depth: 1,
      stencil: 0
    }), this.canvas && this.canvas.parentNode && this.canvas.parentNode.removeChild(this.canvas), this.attributionDivElement && this.attributionDivElement.parentNode && this.attributionDivElement.parentNode.removeChild(this.attributionDivElement), (r = document.getElementById("gl-bench-style")) == null || r.remove(), this.canvasD3Selection = void 0, this.reglInstance = void 0, this.attributionDivElement = void 0, this._isDestroyed = !0);
  }
  /**
  ...
  findHoveredPoint() {
    ...
    if (i[1]) {
      const m = i[0];
      ((o = this.store.hoveredPoint) == null ? void 0 : o.index) !== m && (e = !0);
      const y = i[2], S = i[3];
  ...
  findHoveredLine() {
    ...
    r >= 0 ? (this.store.hoveredLinkIndex !== r && (e = !0), this.store.hoveredLinkIndex = r) : (this.store.hoveredLinkIndex !== void 0 && (n = !0), this.store.hoveredLinkIndex = void 0), e && this.store.hoveredLinkIndex !== void 0 && ((l = (f = this.config).onLinkMouseOver) == null || l.call(f, this.store.hoveredLinkIndex)), n && ((m = (u = this.config).onLinkMouseOut) == null || m.call(u, this.currentEvent));
  }
  updateCanvasCursor() {
